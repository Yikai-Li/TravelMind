...
class DualModelEnricher:
    ...
    def enrich_activity(self, activity: Dict[str, Any], destination: str, day_number: int) -> Dict[str, Any]:
        ...
        if activity_type == 'logistics' and 'check-in' in activity_name.lower():
...
Format as JSON with:
- description, time_slot, cost_details, transport_notes (from airport), booking_url (Booking.com search), sources
"""
